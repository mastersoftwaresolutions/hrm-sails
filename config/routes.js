...
module.exports.routes = {
  ...
  // Custom routes here...
    ...
    'get /api/users': 'UserController.allemployee',
    'post /api/initUser': 'UserController.initUser',
  /**
     * Message routes
     *
     */
    ...
    'post /api/message/save' : 'MessageController.save',
    'get /api/message/:id': 'MessageController.getswitchVal',
    'delete /api/message/:id': 'MessageController.destroy',
    'post /api/message/update/:user' : 'MessageController.update', 
